...
Generative A.I. can try as hard as it can to emulate 3D modelling or 2D art or the stitching of frames to create animations. Self-expression or the *curation* in these frames is going to be where it shines. The *eye* skill-level is going to increase. So, the details are going to be even more necessary. Quality, is going to be even more required than before. While platforms that still serve slop, will become the new wholesale brands.
...
P.S.S. The characteristics of prose kindly provided by [Mistral](https://mistral.ai).

**Key characteristics of prose include:**

- **Natural Flow:** Prose follows the natural flow of speech and thought, making it easier to read and understand.

- **No Meter or Rhyme:** Unlike poetry, prose does not have a regular meter or rhyme scheme.

- **Versatility:** Prose can be used for a wide range of purposes, from storytelling and journalism to academic writing and technical manuals.

- **Structure:** Prose can be structured in various ways, including paragraphs, chapters, and sections, depending on the type of writing.

And to clarify, even if *prose* may define the difference between a novel, essay, or a short story etc. What I mean by a *new prose* are new permutations all-together.